...
extension OpenAISwift {
    ...
    public func sendCompletion(with prompt: String, model: OpenAIModelType = .gpt3(.davinci-002), maxTokens: Int = 16, temperature: Double = 1, completionHandler: @escaping (Result<OpenAI<TextResult>, OpenAIError>) -> Void) {
...
extension OpenAISwift {
    ...
    public func sendCompletion(with prompt: String, model: OpenAIModelType = .gpt3(.davinci-002), maxTokens: Int = 16, temperature: Double = 1) async throws -> OpenAI<TextResult> {
